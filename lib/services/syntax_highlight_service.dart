...
class SyntaxHighlightService {
  ...
  static final _dartRules = <_HighlightRule>[
    ...
    _HighlightRule(r'/\*.*', _Token.comment),
    // Single-line comment
    _HighlightRule(r'//.*', _Token.comment),
  ...
  static final _pythonRules = <_HighlightRule>[
    ...
    // Decorators
    _HighlightRule(r'@\w+', _Token.control),
    _HighlightRule(
    ...
    _HighlightRule(r'\b(?:self|cls)\b', _Token.control),
  ...
  static final _cRules = <_HighlightRule>[
    ...
    _HighlightRule(r'//.*', _Token.comment),
    // Preprocessor
    _HighlightRule(r'#\s*\w+', _Token.control),
    _HighlightRule(r'"(?:[^"\\]|\\.)*"', _Token.string),
    _HighlightRule(r"'(?:[^'\\]|\\.)'", _Token.string),
    _HighlightRule(
  ...
  static final _cppRules = <_HighlightRule>[
    ...
    _HighlightRule(r'//.*', _Token.comment),
    // Preprocessor
    _HighlightRule(r'#\s*(?:include|define|ifdef|ifndef|endif|if|else|elif|'
  ...
  static final _rustRules = <_HighlightRule>[
    ...
    // Attributes
    _HighlightRule(r'#!?\[.*?\]', _Token.control),
    _HighlightRule(
    ...
    // Macro calls
    _HighlightRule(r'\b[a-zA-Z_]\w*!', _Token.control),
    _HighlightRule(r'\b[a-zA-Z_]\w*(?=\s*[\(<])', _Token.function),
  ];
  ...
  static final _rubyRules = <_HighlightRule>[
    _HighlightRule(r'=begin\b.*=end\b', _Token.comment),
    _HighlightRule(r'#.*', _Token.comment),
    _HighlightRule(r':\w+', _Token.string), // symbols
    _HighlightRule(r'(?<!\w)"(?:[^"\\]|\\.)*"', _Token.string),
    _HighlightRule(r"(?<!\w)'(?:[^'\\]|\\.)*'", _Token.string),
    _HighlightRule(r'\b(?:0[xX][0-9a-fA-F_]+|0[oO][0-7_]+|0[bB][01_]+|[0-9][0-9_]*(?:\.[0-9][0-9_]*)?(?:[eE][+-]?[0-9]+)?[ri]?)\b',
        _Token.number),
    _HighlightRule(
    ...
    _HighlightRule(r'\b[a-zA-Z_]\w*[?!]?(?=\s*[\(<])', _Token.function),
    // Method definitions
    _HighlightRule(r'\bdef\s+\w+', _Token.keyword),
  ];
  ...
  static final _xmlRules = <_HighlightRule>[
    ...
    _HighlightRule(r'<\?.*\?>', _Token.control),
    // Closing tag
    _HighlightRule(r'</\s*[a-zA-Z][\w:-]*\s*>', _Token.keyword),
    // Opening tag — tag name
    _HighlightRule(r'<\s*([a-zA-Z][\w:-]*)', _Token.keyword),
    // Attribute values
    _HighlightRule(r'"(?:[^"\\]|\\.)*"', _Token.string),
    _HighlightRule(r"'(?:[^'\\]|\\.)*'", _Token.string),
    // Attribute names
    _HighlightRule(r'\b[a-zA-Z_:][\w:.-]*(?=\s*=)', _Token.function),
    // Self-closing slash
    _HighlightRule(r'/\s*>', _Token.keyword),
    // Entity references
    _HighlightRule(r'&\w+;', _Token.number),
  ];
  ...
  static final _cssRules = <_HighlightRule>[
    _HighlightRule(r'/\*.*\*/', _Token.comment),
    // At-rules
    _HighlightRule(r'@[a-zA-Z-]+\b', _Token.control),
    // Strings
    _HighlightRule(r'"(?:[^"\\]|\\.)*"', _Token.string),
    _HighlightRule(r"'(?:[^'\\]|\\.)*'", _Token.string),
    // Numbers with units
    ...
    // Hex colours
    _HighlightRule(r'#[0-9a-fA-F]{3,8}\b', _Token.number),
    // Properties
    _HighlightRule(
    ...
    // !important
    _HighlightRule(r'!important', _Token.control),
  ];
  ...
  static final _jsonRules = <_HighlightRule>[
    ...
    // Boolean / null
    _HighlightRule(r'\b(?:true|false|null)\b', _Token.keyword),
  ];
  ...
  static final _yamlRules = <_HighlightRule>[
    ...
    _HighlightRule(r"'(?:[^'\\]|\\.)*'", _Token.string),
    // Booleans
    _HighlightRule(r'\b(?:true|false|yes|no|on|off)\b', _Token.keyword),
    // Null
    _HighlightRule(r'\b(?:null|~)\b', _Token.keyword),
    // Numbers
    _HighlightRule(
    ...
    _HighlightRule(r'\.\.\.', _Token.control),
    // Tag
    _HighlightRule(r'!!\w+', _Token.type),
  ];
  ...
  static final _mdRules = <_HighlightRule>[
    // Headings
    _HighlightRule(r'^#{1,6}\s', _Token.keyword),
    // Code fences
    _HighlightRule(r'^```.*', _Token.control),
    _HighlightRule(r'^\s*```', _Token.control),
    // Bold
    _HighlightRule(r'\*\*[^*]+\*\*', _Token.keyword),
    _HighlightRule(r'__[^_]+__', _Token.keyword),
    // Italic
    _HighlightRule(r'\*[^*]+\*', _Token.type),
    _HighlightRule(r'_[^_]+_', _Token.type),
    // Strikethrough
    _HighlightRule(r'~~[^~]+~~', _Token.comment),
    // Inline code
    _HighlightRule(r'`[^`]+`', _Token.string),
    // Links
    _HighlightRule(r'!?\[[^\]]*\]\([^)]*\)', _Token.function),
    // Blockquote
    _HighlightRule(r'^>\s?', _Token.control),
    // Horizontal rule
    _HighlightRule(r'^(?:---|\*\*\*|___)\s*$', _Token.control),
    // List markers
    _HighlightRule(r'^\s*[-*+]\s', _Token.keyword),
    _HighlightRule(r'^\s*\d+\.\s', _Token.number),
  ];
  ...
  static final _shellRules = <_HighlightRule>[
    ...
    _HighlightRule(r'\$\w+', _Token.type),
    // Numbers
    _HighlightRule(r'\b[0-9]+\b', _Token.number),
    // Keywords
    _HighlightRule(
    ...
    // Shebang
    _HighlightRule(r'^#!\s*/\S+', _Token.control),
    // Operators
    _HighlightRule(r'&&|\|\||;;|<<|>>|&|\|', _Token.control),
  ];
}
...
class _HighlightRule {
  ...
  _HighlightRule(String pattern, this.token)
